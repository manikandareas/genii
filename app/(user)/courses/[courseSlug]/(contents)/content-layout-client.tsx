...
type CourseContentQueryResult = {
  ...
  enrollment: Doc<"course_enrollments"> | null | undefined;
};
...
export default function ContentLayoutClient({
  ...
  if (isError || !courseContent) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-background text-foreground">
        <div className="text-center">
          <p className="text-base font-semibold">Kursus tidak ditemukan</p>
          <p className="mt-2 text-sm text-muted-foreground">
            Kami tidak dapat memuat konten untuk kursus dengan slug {courseSlug}
            .
          </p>
        </div>
      </div>
    ...
    <CourseContentProvider value={courseContent}>
      <div className="relative min-h-screen overflow-hidden bg-background text-foreground">
        ...
        <div className="relative z-0 flex min-h-screen">
          ...
          >
            <div className="h-full overflow-y-auto bg-[radial-gradient(circle_at_top,hsl(var(--muted)/0.15),transparent_65%)] px-6 pt-6 pb-48 md:pb-28 md:px-12">
              <div
                className={cn(
